...
function RandomHashFactory(options = {}) {
    let {
        length: _hashLength = 6,
        charset: _charset = 'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789-_'
    } = options;

    const RandomHash = function (options = {}) {
        const {
            length: hashLength = _hashLength,
            charset = _charset
        } = options;
    ...
    Object.defineProperty(RandomHash, 'length', {
        get() {
            return _hashLength;
        },
        set(newHashLength) {
